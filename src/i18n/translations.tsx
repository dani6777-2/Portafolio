...
const es = {
  ...
  'manifesto.statement': 'Diseño aplicaciones cloud-native que convierten problemas de negocio en resultados medibles: menos latencia, más cobertura de pruebas y mejor uptime.',
...
const en: Record<string, string> = {
  ...
  'manifesto.statement': 'I design cloud-native applications that turn business problems into measurable outcomes: less latency, higher test coverage and better uptime.',
  ...
  'connect.marquee': 'Cloud Native | Golang | Microservices | CI/CD | Architecture | Open Source',
